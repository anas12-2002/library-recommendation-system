          ...
          <div className="hidden md:flex items-center space-x-3">
            {!isAuthenticated ? (
              ...
              <button
                ...
                disabled={isLoading}
                className="text-slate-700 hover:text-red-600 transition-colors font-semibold px-4 py-2 rounded-lg hover:bg-red-50 disabled:opacity-60"
              >
                Logout
              </button>
            )}
            ...
            <div className="mt-4 space-y-2">
              {!isAuthenticated ? (
                ...
                <button
                  onClick={handleLogout}
                  disabled={isLoading}
                  className="w-full text-left text-slate-700 hover:text-red-600 transition-colors py-2 px-4 rounded-lg hover:bg-red-50 font-semibold disabled:opacity-60"
                >
                  Logout
                </button>
              )}
